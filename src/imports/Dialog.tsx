import svgPaths from "./svg-wvc9hbd67g";
...
function UseMicrophoneButton() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] items-center justify-center left-[calc(50%-0.5px)] top-[243.5px] translate-x-[-50%] w-[227px]" data-name="Use microphone button">
      <ButtonUseMicro />
    </div>
  );
}
...
export default function Dialog() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[4px] size-full" data-name="Dialog">
