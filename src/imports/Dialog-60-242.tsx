...
function ButtonUseMicro({ onClick }: { onClick: () => void | Promise<void> }) {
  return (
    <div
...
function UseMicrophoneButton({ onClick }: { onClick: () => void | Promise<void> }) {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] items-center justify-center left-[calc(50%-0.5px)] top-[296px] translate-x-[-50%] w-[227px]" data-name="Use microphone button">
      <ButtonUseMicro onClick={onClick} />
    </div>
  );
}
...
function Container3({ onRequestPermissions }: { onRequestPermissions: () => void | Promise<void> }) {
  return (
...
function Container4({ onRequestPermissions }: { onRequestPermissions: () => void | Promise<void> }) {
  return (
...
function BackgroundBorderShadow({ onRequestPermissions }: { onRequestPermissions: () => void | Promise<void> }) {
  return (
...
export default function Dialog({ onRequestPermissions }: DialogProps) {
  return (
