import svgPaths from "./svg-wuk62u4mnk";
...
function Container4() {
  return (
    <div className="box-border content-stretch flex flex-col h-[400px] items-center justify-center max-h-[400px] min-h-[38px] overflow-auto pb-0 pt-[8px] px-0 relative shrink-0 w-full" data-name="Container">
      <Container3 />
    </div>
  );
}
...
function BackgroundBorderShadow() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col h-[447px] items-center justify-center pb-[47px] pt-[37px] px-[21px] relative rounded-[12px] shrink-0 w-[516px]" data-name="Background+Border+Shadow">
