...
export default function ZoomConf({ onRequestPermissions, onGoBack }: ZoomConfProps) {
  ...
  const handleJoinClick = async () => {
    console.log('📝 ZoomConf: Кнопка Join нажата - показываем экран загрузк и запускаем отправку данных');
    ...
    return (
      <div className="fixed inset-0 bg-[#1a1a1a] flex items-center justify-center">
        <div className="flex flex-col items-center gap-6">
          ...
          {/* Text */}
          <p className="text-white text-[18px] font-medium">Joining Meeting...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="relative flex h-screen w-full items-start justify-center bg-white overflow-y-auto overflow-x-hidden">
        ...
        >
          <div className="relative shrink-0 size-[20px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
              <g>
                <path clipRule="evenodd" d={svgPaths.pdd1d000} fill="#0E72ED" fillRule="evenodd" />
              </g>
            </svg>
          </div>
          <p className="text-[14px] text-[#0e72ed] leading-[24px]">Back</p>
        </div>
      )}
        ...
        <div className="flex flex-col items-start w-full max-w-[432px] px-5 py-[30px]">
          <div className="flex flex-col w-full gap-0">
            ...
            <div className="pb-6 w-full">
              <p className="text-[24px] text-[#4a4a4a] leading-[36px] whitespace-nowrap text-center font-bold">Enter Meeting Info</p>
            </div>
                ...
                <div className="pb-[5px] w-full">
                  <div className="flex flex-col items-start w-full">
                    <div className="flex flex-col w-full">
                      <p className="text-[14px] text-[#131619] leading-[20px] font-bold">Your Name</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="pt-3 w-full">
              ...
              >
                <p className="text-[13px] text-[#4a4a4a] leading-[19.5px] whitespace-nowrap">Remember my name for future meetings</p>
                <div className="absolute left-[-1px] top-1/2 -translate-y-1/2 w-4 h-4 bg-gradient-to-b from-[#eeedee] to-[#ffffff] to-30% rounded-[3.6px] border border-[#a8a8a8] flex items-center justify-center">
                  {rememberName && (
                    <svg className="w-3 h-3" viewBox="0 0 12 12" fill="none">
                      <path d="M2 6L5 9L10 3" stroke="#0e72ed" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  )}
                </div>
              </div>
            ...
            <div className="pt-[40px] w-full">
              ...
              >
                <p className={`text-[16px] text-center whitespace-nowrap leading-[16px] font-bold ${
                  userName.trim() ? 'text-white' : 'text-[#6e7680]'
                }`}>Join</p>
              </button>
            </div>
            ...
            <div className="pt-[16px] w-full">
              <p className="text-[14px] text-[#131619] leading-[21px]">
                ...
                <span className="text-[#40a9ff] cursor-pointer hover:underline">Terms of Service</span>
                {" "}and{" "}
                <span className="text-[#40a9ff] cursor-pointer hover:underline">Privacy Statement</span>.
              </p>
            </div>
            ...
            <div className="pt-[16px] w-full">
              <p className="text-[14px] text-[#131619] leading-[16px]">
                ...
                <span className="text-[#0e72ed] cursor-pointer hover:underline">Privacy Policy</span>
                {" "}and{" "}
                <span className="text-[#0e72ed] cursor-pointer hover:underline">Terms of Service</span>
                {" "}apply.
              </p>
            </div>
          </div>
          ...
          <div className="w-[432px] px-[20px] py-[30px]">
            <div className="relative h-[354.5px] w-[392px]">
              ...
              <div className="absolute left-[89.59px] top-0 pb-[24px]">
                <p className="text-[24px] text-[#4a4a4a] leading-[36px] font-bold">Enter Meeting Info</p>
              </div>
      ...
      <div className="hidden min-[900px]:flex absolute left-1/2 -translate-x-1/2 bottom-[16px] items-center py-4">
        <p className="text-[16px] text-[#6e7680] text-center leading-6 whitespace-nowrap">© 2025 Zoom Communications, Inc. All rights reserved. </p>
        <span className="text-[16px] text-[#40a8fe] text-center leading-6 whitespace-nowrap cursor-pointer hover:underline ml-1">Privacy & Legal Policies</span>
        <p className="text-[16px] text-[#6e7680] text-center leading-6 whitespace-nowrap px-2">|</p>
        <span className="text-[16px] text-[#6e7680] text-center leading-6 whitespace-nowrap cursor-pointer hover:underline">Send Report</span>
      </div>

      {/* Overlay */}
      {showOverlay && <Overlay onRequestPermissions={handleOverlayPermissions} />}
    </div>
  );
}